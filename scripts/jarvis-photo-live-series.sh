...
: > "$SUMMARY_FILE"
: > "$TSV_FILE"
printf 'trial\tstatus\tfailure_type\tparsed_source\tstt_text\tready_for_speech\tspeech_begin\tpartial_results\tfinal_results\tlog_file\tdiagnostic_log_file\toutput_file\n' > "$TSV_FILE"
