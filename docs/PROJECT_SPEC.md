...
1. ASR-first wake 경로에서 실제 `자비스 깨어나` live 발화가 command window로 들어가는지 실기기 확인
2. owner verification score가 낮아 activation owner rejection이 발생하는 경우 threshold와 등록 샘플 품질 재점검
