...
- Android STT command window는 짧은 명령 구문에 맞춰 `LANGUAGE_MODEL_WEB_SEARCH`, minimum input 180ms, possibly-complete silence 90ms, complete silence 180ms를 사용한다. 빠른 실행은 final보다 partial command path로 우선 달성한다.
