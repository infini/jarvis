...
class SpeechRecognitionIntentFactoryTest {
    ...
    fun commandWindowBiasesRecognizerTowardSupportedCommandPhrases() {
        ...
        assertTrue("자베스 사진 찍어주세요" in biasingStrings)
        assertTrue("서비스 사진 찍어 주세요" in biasingStrings)
        ...
        assertTrue("자비스 사진 찌겨" in biasingStrings)
        assertTrue("자비스 사진 지겨" in biasingStrings)
        assertTrue("자비스 사진 치겨" in biasingStrings)
        assertTrue("자비스 사진 찍혀" in biasingStrings)
        assertTrue("자비스 사진 지켜" in biasingStrings)
        assertTrue("자비스 찌거" in biasingStrings)
        assertTrue("자비스 치거" in biasingStrings)
        assertTrue("자비서 사진 지거" in biasingStrings)
        assertTrue("제이비스 사진 치겨" in biasingStrings)
        assertTrue("서비스 사진 찍혀" in biasingStrings)
        assertTrue("자비서 찌거" in biasingStrings)
        assertTrue("제이비스 치꺼" in biasingStrings)
        assertTrue("서비스 지꺼" in biasingStrings)
        ...
        assertTrue("자비스 사진찍어" in biasingStrings)
        assertTrue("자베스 사진찍어줘" in biasingStrings)
        assertTrue("쟈비스 사진찍어주세요" in biasingStrings)
        assertTrue("제이비스 사진찍" in biasingStrings)
        assertTrue("자비서 사진찌" in biasingStrings)
        assertTrue("서비스 사진치" in biasingStrings)
