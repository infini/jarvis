...
object SpeechRecognitionIntentFactory {
    ...
    private const val COMMAND_INPUT_MINIMUM_LENGTH_MS = 520L
    private const val COMMAND_POSSIBLY_COMPLETE_SILENCE_MS = 300L
    private const val COMMAND_COMPLETE_SILENCE_MS = 650L
}
